...
cap = cv2.VideoCapture('video.mp4')  # capture frames from a video
...
while True:
    ...
    cars = cars_detection = car_detection.detectMultiScale(gray, 1.1, 1)   # Detects cars of different sizes in the input image
